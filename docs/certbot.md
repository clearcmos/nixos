...
These files are automatically created during system activation by the NixOS nginx module and can be referenced in your nginx configurations. The activation script in the nginx module ensures these files exist and have the correct content.
